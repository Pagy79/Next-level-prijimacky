...
const COSMIC_GLASS_CARD_STYLE = {
  backgroundImage:
    "linear-gradient(rgba(15, 23, 42, 0.72), rgba(15, 23, 42, 0.72)), url('/images/bg-a20b26b78d.jpg')",
...
const COSMIC_GLASS_CARD_STYLE_SETTINGS = {
  backgroundImage:
    "linear-gradient(rgba(15, 23, 42, 0.72), rgba(15, 23, 42, 0.72)), url('/images/bg-9bcc9f8553.jpg')",
  backgroundSize: "cover",
  backgroundPosition: "center",
  borderColor: "rgba(34, 211, 238, 0.3)",
  boxShadow: "0 0 30px rgba(56, 189, 248, 0.15), 0 25px 50px -12px rgba(15, 23, 42, 0.5)",
...
const COSMIC_GLASS_CARD_STYLE_FULLTEST = {
  backgroundImage:
    "linear-gradient(rgba(15, 23, 42, 0.72), rgba(15, 23, 42, 0.72)), url('/images/bg-47d40cd9b1.jpg')",
  backgroundSize: "cover",
  backgroundPosition: "center",
  borderColor: "rgba(34, 211, 238, 0.3)",
  boxShadow: "0 0 30px rgba(56, 189, 248, 0.15), 0 25px 50px -12px rgba(15, 23, 42, 0.5)",
...
const COSMIC_GLASS_CARD_STYLE_ASTROLABE = {
  backgroundImage:
    "linear-gradient(rgba(15, 23, 42, 0.72), rgba(15, 23, 42, 0.72)), url('/images/bg-866a93636a.jpg')",
  backgroundSize: "cover",
  backgroundPosition: "center",
  borderColor: "rgba(34, 211, 238, 0.3)",
  boxShadow: "0 0 30px rgba(56, 189, 248, 0.15), 0 25px 50px -12px rgba(15, 23, 42, 0.5)",
...
const COSMIC_GLASS_CARD_STYLE_BOOK = {
  backgroundImage:
    "linear-gradient(rgba(15, 23, 42, 0.72), rgba(15, 23, 42, 0.72)), url('/images/bg-2de001ed0c.jpg')",
  backgroundSize: "cover",
  backgroundPosition: "center",
  borderColor: "rgba(34, 211, 238, 0.3)",
  boxShadow: "0 0 30px rgba(56, 189, 248, 0.15), 0 25px 50px -12px rgba(15, 23, 42, 0.5)",
...
const COSMIC_GLASS_CARD_STYLE_WATCH = {
  backgroundImage:
    "linear-gradient(rgba(15, 23, 42, 0.72), rgba(15, 23, 42, 0.72)), url('/images/bg-563c4a1a30.jpg')",
  backgroundSize: "cover",
  backgroundPosition: "center",
  borderColor: "rgba(34, 211, 238, 0.3)",
  boxShadow: "0 0 30px rgba(56, 189, 248, 0.15), 0 25px 50px -12px rgba(15, 23, 42, 0.5)",
